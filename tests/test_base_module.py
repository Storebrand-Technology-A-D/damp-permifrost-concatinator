...
def test_base_module_add_entities(object1):
    ...
    assert base_module.spesification == {"entitiy1": {"key": "value"}, "entitiy2": {"key": "value"}}
...
def test_base_module_get_entitiy(base_module_loaded):
    assert base_module_loaded.get_entitiy("entitiy1") == {"key": "value"}

def test_base_module_get_entitiy_not_found(base_module_loaded):
    with pytest.raises(Exception) as exception_info:
        base_module_loaded.get_entitiy("entitiy4")
