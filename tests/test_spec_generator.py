...
def test_spec_generator_singel_user_generator(singel_user_object, singel_user_object_str_result):
...
def test_spec_generator_generate_single_database(single_database_object, single_database_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
...
@pytest.fixture 
def databases_object_str_results():
    return f"""databases:\n{space*1}- database1:\n{space*2}shared: yes\n{space*2}owner: loader_qlik\n{space*1}- database2:\n{space*2}shared: no\n{space*2}owner: loader_qlik\n{space*1}- database3:\n{space*2}shared: yes\n"""
 

def test_spec_generator_generate_databases(databases_object, databases_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
...
def test_spec_generator_generate_single_warehouse(single_warehouse_object, single_warehouse_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
    spec_generator.generate(single_warehouse_object)
    assert (
        spec_generator.warehouses
        == single_warehouse_object_str_results
    )

@pytest.fixture
def warehouses_object_str_results():
    return f"""warehouses:\n{space*1}- warehouse1:\n{space*2}size: xsmall\n{space*1}- warehouse2:\n{space*2}size: xsmall\n{space*1}- warehouse3:\n{space*2}size: medium\n"""

def test_spec_generator_generate_warehouses(warehouses_object, warehouses_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
...
def test_spec_generator_generate_single_functional_role(single_functional_role_object, single_functional_role_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
    spec_generator.generate(single_functional_role_object)
    assert (
        spec_generator.functional_roles
        == single_functional_role_object_str_results
    )
...
def test_spec_generator_generate_multiple_functional_roles(functional_roles_object, functional_roles_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
    spec_generator.generate(functional_roles_object)
    assert (
        spec_generator.functional_roles
        == functional_roles_object_str_results 
    )
...
def test_spec_generator_generate_accsess_roles(single_accsess_role_object, single_accsess_role_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
...
def test_spec_generator_generate_multiple_accsess_roles(accsess_roles_object, accsess_roles_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
    spec_generator.generate(accsess_roles_object)
    assert (
        spec_generator.access_roles
        ==  accsess_roles_object_str_results )
...
def test_spec_generator_generate_roles(roles_object, roles_object_str_results):
    spec_generator = Spec_Generator("0.14.0")
...
def test_spec_generator_generate_multiple_modules(databases_object, warehouses_object, databases_object_str_results, warehouses_object_str_results):
