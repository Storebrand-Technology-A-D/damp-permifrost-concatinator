...
def test_permisison_state_generate(spesification_team_c_verified, team_c_verefied_state_file):
    """
    ...
    assert permission_state.state_file.keys() == {'version', 'serial', 'modules', 'generated'}
